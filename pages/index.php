...
$query = "SELECT * FROM my_icsse.post where id = (select max(id) FROM my_icsse.post)";
			...
			<div class="col-8 noidung1">
				...
				foreach($result as $item) {
					...
					<div class="inside">
						...
						<p style="font-family: initial;margin-top: 20px;font-size: 15px; text-align: justify; padding-left:10px";>
