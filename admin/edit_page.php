...
<body>
	...
	<div class="container">
		...
		<form action="../helpers/submit_change.php" method="POST">
			<div class="form-group">
				<label for="usr">Tiêu đề</label>
				<input type="text" class="form-control" id="usr" name="title" value="<?php echo $result['title']?>">
				<input type="hidden" class="form-control" id="usr" name="id" value="<?php echo $result['id']?>">
			</div>
			<div class="form-group">
